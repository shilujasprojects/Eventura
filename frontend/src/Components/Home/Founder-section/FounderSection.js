  ...
  return (
    ...
    <section class="eventura-hero">
      <div class="container">
        <div class="hero-grid">
          {/* LEFT CONTENT */}
          <div class="hero-founder-content" data-aos="fade-up" data-aos-duration="2000">
            <div class="founder">
        ...
        {/* STATS Card */}
        <div class="hero-stats" data-aos="zoom-out-down" data-aos-duration="1500">
          <div class="stat-card" >
            <h3>8+</h3>
